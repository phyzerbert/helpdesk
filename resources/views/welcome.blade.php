    ...
    <header id="header">
        <div class="container-fluid">
            ...
            <div id="logo" class="pull-left">
                <h1><a href="#intro" class="scrollto">Bolton IT Help Desk</a></h1>
  ...
  ============================-->
    <footer id="footer">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-info">
                        ...
                        <p>Bolton IT Help Desk is a game changer in turning IT teams from daily fire-fighting to delivering awesome customer service. It provides great visibility and central control in dealing with IT issues to ensure that businesses suffer no downtime. For 10 years and running, it has been delivering smiles to millions of IT folks, end users, and stakeholders alike.</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="credits">
                Designed by <a href="https://bootstrapmade.com/">Yuyuan Zhang</a>
            </div>
        </div>
    </footer><!-- #footer -->
